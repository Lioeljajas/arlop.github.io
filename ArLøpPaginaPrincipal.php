    ...
    function confirmarCierreSesion(event) {
            ...
            <ul class="navbar-list">
                <li class="navbar-item">
                    ...
                    <div class="submenu">
                        <p>Servicios</p>
                        <br>
                        <a href="ArLøpInstrumentos.php#acoustic-guitars-section" class="nav-link">Comprar Guitarras Acusticas</a><br>
                        <br>
                        <a href="ArLøpInstrumentos.php#electric-guitars-section" class="nav-link">Comprar Guitarras Electricas</a><br>
                        <br>
                        <a href="ArLøpInstrumentos.php#electric-bass-section" class="nav-link">Comprar Bajos Electricos</a><br>
                        <br>
                        <a href="ArLøpInstrumentos.php#drums-section" class="nav-link">Comprar Baterias</a><br>
                        <br>
                        <a href="ArLøpInstrumentos.php#acordions-section" class="nav-link">Comprar Acordeones</a><br>
                        <br>
                        <a href="ArLøpInstrumentos.php#pedals-section" class="nav-link">Comprar Pedales</a><br>
                        <br>                        
                    </div>
                </li>
                <li class="navbar-item">
        ...
        <div class="section">
            <div class="small-container">
                <a href="ArLøpInstrumentos.php#electric-guitars-section" class="box small" style="background-image: url('https://images.unsplash.com/photo-1564186763535-ebb21ef5277f?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z3VpdGFyfGVufDB8fDB8fHww');">
                    <div class="content">Guitarras Electricas</div>
                </a>
                <a href="ArLøpInstrumentos.php#acoustic-guitars-section" class="box small" style="background-image: url('https://wallpapercave.com/wp/6coseCd.jpg');">
                    <div class="content">Guitarras Acusticas</div>
                </a>
            </div>
                <a href="ArLøpInstrumentos.php#electric-bass-section" class="box large" style="background-image: url('https://toppng.com/uploads/preview/guitars-bass-guitar-electric-guitar-musical-instruments-11570026616qvrhkdaq6f.jpg');">
                <div class="content">Bajos Electricos</div>
                </a>
            </div>
            <div class="section">
                <a href="ArLøpInstrumentos.php#drums-section" class="box large" style="background-image: url('https://img.freepik.com/free-photo/drums-conceptual-image_1204-197.jpg');">
                <div class="content">Baterias</div>
                </a>
            <div class="small-container">
                <a href="ArLøpInstrumentos.php#acordions-section" class="box small" style="background-image: url('https://bluestarbiz.com/wp-content/uploads/2023/04/midjourney-ai-photograph_blue_accordion.png');">
                    <div class="content">Acordeones</div>
                </a>
                <a href="ArLøpInstrumentos.php#pedals-section" class="box small" style="background-image: url('https://c0.wallpaperflare.com/preview/630/905/103/united-states-rancho-cucamonga-abundant-living-family-church-bass.jpg');">
