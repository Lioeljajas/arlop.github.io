...
<html>
    ...
    <link rel="stylesheet" href="assets/css/design-instrumentos-beta.css">    
    <script>
            function toggleMode() {
...
function mostrarModal(id) {
    ...
    function confirmarCierreSesion(event) {
        ...
        function redirigir() {
            window.location.href = "login.php"; // Redirige a otra página
        }
</script>
    ...
    <body>
        ...
        <div id="sidebar1" class="sidebar">
            <center>
                <h2>Registrate</h2>
                <br>
                <p>Registrate para Seguir Comprando Productos</p>
                <div class="divisorimage">
                    <img src="https://static.vecteezy.com/system/resources/previews/032/980/801/original/electric-guitar-icon-vector.jpg" style="border-radius: 50%; border-color:aquamarinej" alt="Imagen" class="hover-image" onclick="redirigir()">
                </div>
                <p>da Click en la Imagen para Registrarte</p>
            </center>
        </div>
            ...
            <div class="grid-container">
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://media.auvisa.com/120921-home_default/fender-cc60s-all-mahogany-wn-guitarra-acustica-concierto-natural.jpg" alt="Imagen 1" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
                ...
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://encrypted-tbn1.gstatic.com/shopping?q=tbn:ANd9GcTRlWxWsCBVNcnKXgr1VEJjnrUqdPZgEhthS6R4EGssqxooRg9LZ7ScFRm3Va-27cO8wYZJ-xqUnoEGOVJIo-M8TFnRfm2vhhS4KlI1Syu8&usqp=CAc" alt="Imagen 2-a" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
                ...
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://m.media-amazon.com/images/I/5110xfPVTWL.jpg" alt="Imagen 3-a" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
                ...
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://www.musicanarias.com/8806-thickbox_default/guitarra-electroacustica-taylor-814ce.jpg" alt="Imagen 4-a" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
                ...
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://i0.wp.com/marikomusic.com.mx/wp-content/uploads/2022/06/Guitarra-Acustica-Clasica-JMT-AC851-Negra.jpg?fit=1000%2C1000&ssl=1" alt="Imagen 5-a" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
                ...
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://i0.wp.com/marikomusic.com.mx/wp-content/uploads/2023/10/Guitarra-Acustica-Clasica-Squier-SA150N.jpg?fit=1000%2C1000&ssl=1" alt="Imagen 6-a" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
        ...
        <div class="electric-guitars-section">
            <div class="grid-container">
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://ss631.liverpool.com.mx/xl/1122438917.jpg" alt="Imagen 1-b" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
                ...
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://ss631.liverpool.com.mx/xl/1119824318.jpg" alt="Imagen 2-b" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
                ...
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://musicaltamayo.com/2953-large_default/jackson-rrx24-black.jpg" alt="Imagen 3-b" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
                ...
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://therocklab.mx/cdn/shop/files/static.gibson.com_product-images_USA_USAANM97_Satin_Cherry_Sunburst_LPTR00WSNH1_1_1024x1024.jpg?v=1698348985" alt="Imagen 4-b" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
                ...
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://static.gibson.com/product-images/Custom/CUST9M301/Ebony/DSMXEBGH1E_Front1.jpg" alt="Imagen 5-b" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
                ...
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://ss631.liverpool.com.mx/xl/1137456211.jpg" alt="Imagen 6-b" onclick="openSidebar('sidebar1')">
                            <h2>
                                <script>
        ...
        <div class="electric-bass-section">
            <div class="grid-container">
                <div class="element-separator">
                    <div class="image-container">
                        <center>
                            <img src="https://www